...
import { TextTube } from '../ui/text-tube.component';

export const Text3DExample: React.FC = () => {
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="w-full h-screen relative">
        ...
        {/* Spotify Logo */}
        <a 
          href="https://spotifywrapped.com/en/" 
          target="_blank" 
          rel="noopener noreferrer"
          className="absolute top-6 left-1/2 transform -translate-x-1/2 w-24 h-auto"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 558.43 167.49" className="w-full h-full">
