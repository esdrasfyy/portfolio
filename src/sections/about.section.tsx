  ...
  return (
    <section id="about" className="h-screen bg-secondary text-text-reverse py-16">
      <div className="max-w-[1500px] h-full mx-auto px-8 flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center w-full">
              ...
              <div className="grid grid-cols-2 gap-4 w-2/5">
                {experienceCards.map((card, index) => (
                  <div key={index} className="experience-card-js bg-primary h-24 text-text relative rounded-md flex p-4 flex-col transition-all duration-700 border border-white/20">
        ...
        <div ref={containerRef} style={{ position: "relative" }} className="rounded-2xl overflow-hidden">
