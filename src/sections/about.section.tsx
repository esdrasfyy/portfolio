...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="min-h-screen bg-secondary text-text-reverse py-28">
      <div className="max-w-[1500px] mx-auto px-8 h-[calc(100vh-210px)] flex flex-col justify-between">
        <div className="col-span-4 flex justify-between">
          ...
          <h3 className="max-w-xl text-3xl text-end font-semibold">I'm a software engineer with a passion for building scalable and efficient web applications.</h3>
        </div>
        <div className="flex justify-between gap-16">
          <div className="space-y-6 w-full">
            ...
            <div className="space-y-4">
              <p className="leading-relaxed text-xl font-thin">Unlock your digital potential with custom web solutions that drive results. I specialize in creating high-performance websites and applications that transform your business goals into digital success.</p>
              <p className=" leading-relaxed font-bold max-w-4/5">Whether you need a fast landing page, a complex e-commerce platform, or a custom web application, I deliver solutions that exceed expectations and drive measurable results.</p>
            </div>
          </div>
          <div className="space-y-6 w-full">
            <div>
              <h2 className="text-4xl font-bold text-end">Skills</h2>
              <h3 className="text-xs uppercase opacity-50 font-bold text-end">MY TOP</h3>
            </div>
            <div className="space-y-4">
              <p className="leading-relaxed text-xl font-thin text-end">Turning ideas into digital experiences that matter. From front-end design to scalable back-end systems, I build solutions with performance, clarity, and impact. rmance, clarity, and impact</p>
              <p className=" leading-relaxed font-bold max-w-4/5 text-end ml-auto">Landing pages, e-commerce platforms, or custom applications — every project is crafted to deliver results. Code that works. Design that connects. Tech that scales.</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="rounded-2xl overflow-hidden">
            <div className="flex animate-scroll items-center">
              {["React", "TypeScript", "Next.js", "Node.js", "Express", "MongoDB", "PostgreSQL", "Tailwind CSS", "Framer Motion", "Swiper.js", "Vite", "Git", "Docker", "AWS", "Vercel", "Figma", "Adobe XD", "JavaScript", "HTML5", "CSS3", "SASS", "Webpack", "Jest", "Cypress"].map((tech, index) => (
                <div
                  key={index}
        ...
        <div className="col-span-12 grid grid-cols-4 gap-4">
          {serviceCards.map((card, index) => (
            ...
            >
              <h3 className="text-lg font-semibold transition-colors duration-700">{card.title}</h3>
              <p className="text-xs text-gray-500 transition-colors duration-700">{card.description}</p>
